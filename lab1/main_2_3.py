...
image_idx = 1  # indice dell'immagine da testare
...
plt.show()
# Save the image
image_file = 'real_image_label_' + str(classes[label]) + '.jpg'
...
cv2.imwrite('CAM_image_label_' + str(classes[label]) + '.jpg', result)

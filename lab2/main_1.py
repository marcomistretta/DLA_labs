...
# hyperparameters
batch_size = 48  # 64,  how many independent sequences will we process in parallel?
...
model_name = "dante_default_big_lr"

train_txt = "dante_train.txt"
output_txt = "./results/" + model_name + "/" + model_name + ".txt"
save_model_path = "./results/" + model_name + "/" + model_name + ".pth"
writer = SummaryWriter("./results/" + model_name)
save_model = True
